...
class DataModif(BaseEstimator):
    ...
    def DataModif(self, Data):
        ...
        for i in range(len(Data)):
            ...
            if  (not Data[i][1] in self.auxUserList):
                self.auxUserList.append(Data[i,1]) #auxilary list with movie id
...
if __name__ == "__main__":
    ...
    #D2 = D.loadData("/home/pitou/mini_projet2/starting_kit_project/public_data/movierec_train2.data")
    print("*** Original data ***")
    #print D
